...
export class DefaultService {
	 ...
	 * @throws ApiError
	 */
	public static postApiV1Accounts(body: CreateAccounts): CancelablePromise<Array<Account>> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/accounts',
			body: body,
	 ...
	 * @throws ApiError
	 */
	public static getApiV1Accounts1(accountId: number): CancelablePromise<Account> {
		return __request(OpenAPI, {
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static postApiV1Accounts1(body: UpdateAccount, accountId: number): CancelablePromise<Account> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/accounts/{account_id}',
			path: {
	 ...
	 * @throws ApiError
	 */
	public static deleteApiV1Accounts(accountId: number): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'DELETE',
			url: '/api/v1/accounts/{account_id}',
			path: {
	 ...
	 * @throws ApiError
	 */
	public static postApiV1AccountsRelink(body: RelinkAccount, accountId: number): CancelablePromise<Account> {
		return __request(OpenAPI, {
			method: 'POST',
	 ...
	 * @throws ApiError
	 */
	public static postApiV1AccountsSync1(accountId: number): CancelablePromise<Array<Transaction>> {
		return __request(OpenAPI, {
			method: 'POST',
	 ...
	 * @throws ApiError
	 */
	public static postApiV1Functions(body: CreateFunction): CancelablePromise<Function> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/functions',
			body: body,
	 ...
	 * @throws ApiError
	 */
	public static getApiV1Functions1(functionId: number): CancelablePromise<FunctionWithParams> {
		return __request(OpenAPI, {
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static postApiV1Functions1(body: UpdateFunction, functionId: number): CancelablePromise<Function> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/functions/{function_id}',
			path: {
	 ...
	 * @throws ApiError
	 */
	public static deleteApiV1Functions(functionId: number): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'DELETE',
			url: '/api/v1/functions/{function_id}',
			path: {
	 ...
	 * @throws ApiError
	 */
	public static postApiV1FunctionsTest(body: TestFunction, functionId: number): CancelablePromise<string> {
		return __request(OpenAPI, {
			method: 'POST',
	 ...
	 * @throws ApiError
	 */
	public static postApiV1Requisitions(body: CreateRequisition): CancelablePromise<Requisition> {
		return __request(OpenAPI, {
			method: 'POST',
	 ...
	 * @throws ApiError
	 */
	public static getApiV1Transactions1(transactionId: number): CancelablePromise<TransactionWithMerchant> {
		return __request(OpenAPI, {
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static deleteApiV1Transactions(transactionId: number): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'DELETE',
			url: '/api/v1/transactions/{transaction_id}',
			path: {
	 ...
	 * @throws ApiError
	 */
	public static postApiV1Triggers(body: CreateTrigger): CancelablePromise<Trigger> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/triggers',
			body: body,
	 ...
	 * @throws ApiError
	 */
	public static getApiV1Triggers1(triggerId: number): CancelablePromise<Trigger> {
		return __request(OpenAPI, {
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static postApiV1Triggers1(body: UpdateTrigger, triggerId: number): CancelablePromise<Trigger> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/triggers/{trigger_id}',
			path: {
	 ...
	 * @throws ApiError
	 */
	public static deleteApiV1Triggers(triggerId: number): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'DELETE',
			url: '/api/v1/triggers/{trigger_id}',
			path: {
	 ...
	 * @throws ApiError
	 */
	public static postApiV1Users(body: NewUser): CancelablePromise<User> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/users',
			body: body,
	 ...
	 * @throws ApiError
	 */
	public static postApiV1UsersMe(body: UpdateUser): CancelablePromise<User> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/users/me',
			body: body,
	 ...
	 * @throws ApiError
	 */
	public static postApiV1UsersSession(body: CreateSession): CancelablePromise<User> {
		return __request(OpenAPI, {
			method: 'POST',
